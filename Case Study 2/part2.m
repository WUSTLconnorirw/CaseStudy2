...
ub = [0.08 0.05 0.5 0.89038, 0.000207, 0.10335, 0.0020576]';
lb = [0 0 0 0.89038, 0, 0, 0]';
x0 = [0.03, 0.01, 0.01, 0.8893, 0.001,0,0]; 
...
ub = [5.9650e-05 0.05 0.5 0.8960, 0.1, 0, 0]';
lb = [0 0 0 0.8960, 0, 0, 0]';
x0 = [5.9650e-05, 0.01, 0.01, 0.902, 0.001,0,0]; 

x = fmincon(sirafun,x0,A,b,Af,bf,lb,ub);
Y_fit3 = siroutput_full(x,t);

%days 501 to 605 fit after policy%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
td = 501:605;
t = length(td);
coviddata = table2array([COVID_STLmetro(td,"cases")...
    COVID_STLmetro(td,"deaths")]);
...
ub = [2.6582e-04 0.05 0.5 0.8918, 0.0001551, 0.102, 0.001986]';
lb = [0 0 0 0.8918, 0, 0, 0]';
x0 = [2.6582e-04, 0.01, 0.01, 0.8893, 0.001,0,0]; 
...
l1 = plot(td_fit,(ones([t,1])'-Y_fit(1:t,1)));
l2 = plot(td,Y_fit(1:t,4));
l3 = plot(td_fit,(ones([t,1])'-Y_fit_p(1:t,1)));
l4 = plot(td,Y_fit_p(1:t,4));
l5 = plot(td,coviddata(:,1),'r');
l6 = plot(td,coviddata(:,2));
legend([l1(1),l2,l3(1),l4,l5,l6],"Simulated Infected Before policy",...
